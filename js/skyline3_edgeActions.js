...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 29236, function(sym, e) {
         this.play(0)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 35100, function(sym, e) {
         this.play(0)
...
})(jQuery, AdobeEdge, "EDGE-skyline3");